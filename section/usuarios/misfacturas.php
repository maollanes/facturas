				...
				<div class="body" style="border: 0px solid grey;">
					<div class="body_special">	
						...
						<div class="table-calificaciones">
							<div class="title-table"><h2>Mis Facturas</h2></div>
							<div class="info_varias" style="width:90%;">
								...
								<div class="cont-fact">
									<div class="title-table-fact"><h2>Mis Facturas</h2></div>
									<?php
									if($id_fac2 != ""){
									?>
									<table border="0" class="table-fact">
										...
										<tr>
											<th>N° Fact</th>
											<th colspan="2">Nombre Factura</th>
										...
										<tr>
											...
											<td>'.$fe_cre.'</td>
											<td>'.$fe_com.'</td>
											<td><a href=javascript:confirmacion('.$id_fac.') title="Eliminar Factura"><img src="../../images/delete.png"></a></td>
										</tr>
										');
										}
										?>
								...
								<div class="botones-fact">
									<div class="cont-button"><a href="" class="button">Nueva Factura</a></div>
								</div>	
								<div class="info-fact">
									<div class="info"><span>INFORMACIÓN: En ésta sección usted podrá ver en una tabla, las plantillas de facturas que ha creado, mostrándose por Número de Factura.</span></div>
								</div>					
							</div>
						</div>
					</div>
