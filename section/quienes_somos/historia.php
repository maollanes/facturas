			...
			<div class="master_2">
				...
				<div class="nav">
					...
					<ul>
						...
						<ul><span></span>
							<li><a href="objetivos.php">° Objetivo</a></li>
				...
				<div class="body" style="border: 0px solid grey;">
					<div class="body_special">	
						...
						<div class="table-calificaciones">
							<div class="title-table"><h2>Historia</h2></div>
							<div class="info_varias" style="width:65%; text-align:justify;font-size:small; padding-top:20px; height:auto;">
								...
								<p>HISTORIA</p>
								<p>El 10 de diciembre de 2003, la Secretaría de Educación Pública del Gobierno Federal y el Gobierno del Estado de México firmaron, un convenio de Coordinación para la Creación, Operación y Apoyo Financiero de la Escuela Normal Rolando Mota, a fin de contribuir a la consolidación de los programas de desarrollo de la educación superior en la entidad.</p>
								<p>En cumplimiento de dicho convenio, el Gobierno del Estado  expidió el Decreto del Ejecutivo del Estado, por el que se crea el Organismo Público Descentralizado de Carácter Estatal Denominado Escuela Normal Rolando Mota, publicado en la Gaceta del Gobierno el 10 de diciembre de 2003, a través del cual se le dota de personalidad jurídica y patrimonio propios.</p>
							</div><br><br><br><br>
						</div>
					</div>
				</div>
